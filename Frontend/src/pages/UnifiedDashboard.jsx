    ...
    >
      ...
      <motion.div variants={itemVariants}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
          ...
          <div className="p-4 bg-[var(--bg-secondary)] border border-border/50 rounded-[var(--radius-lg)] text-center flex flex-col justify-center transition-all hover:scale-[1.02] hover:border-[var(--primary)]/30 duration-200 shadow-sm col-span-2 sm:col-span-1">
