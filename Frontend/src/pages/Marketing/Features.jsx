    ...
    <div className="w-full uc-modern-container" style={{ paddingTop: "52px", paddingBottom: "72px" }}>
      ...
      <div className="flex flex-col gap-16">
        ...
        <section className={sectionGrid}>
          ...
          <TabletFrame><TutorialsPreview /></TabletFrame>
        </section>
        ...
        <section className={sectionGrid}>
          <div className="lg:order-first">
            <MobileFrame><ReferralsPreview /></MobileFrame>
          </div>
          <div className={textCol}>
        ...
        <section className={sectionGrid}>
          <div className={textCol}>
            ...
            <h2 className={featureHeading}>Class Attendance Tracker</h2>
            <p className={featureDesc}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                { e: "⚠️ 75% Credit Limit Warning", d: "Triggers automatic warning notifications as attendance drops below required margins." },
                { e: "🔄 Attendance Sync", d: "Tutor bookings automatically update attendance states in the central dashboard databases." },
                { e: "📊 Automated Reports", d: "Download formal PDF report tables representing class logs for university verifications." },
                { e: "🏫 Multi-Class Support", d: "Manage complex block structures and laboratory schedules under one dashboard." },
              ].map(({ e, d }, i) => (
                <div key={i} className="p-4 bg-card border border-border rounded-[var(--radius-md)] space-y-1">
                  <h4 className="text-xs font-bold text-foreground">{e}</h4>
                  <p className="text-[10px] text-muted-foreground leading-normal">{d}</p>
                </div>
              ))}
            </div>
            <div>
              <Link to="/features/attendance" className="uc-btn-primary bg-gradient-to-r from-emerald-500 to-teal-500 inline-flex items-center gap-1.5">
                Launch Attendance Module <ArrowRight className="w-3.5 h-3.5" />
              </Link>
            </div>
          </div>
          <TabletFrame><AttendancePreview /></TabletFrame>
        </section>
        ...
        <section className={sectionGrid}>
          <div className={textCol}>
            ...
            <h2 className={featureHeading}>Smart Expenses &amp; Budgeting</h2>
            <p className={featureDesc}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {[
                { e: "💰 Spend Logs", d: "Log expenses instantly on-the-go categorized by Food, Books, Transit." },
                { e: "📊 Analytics", d: "Responsive category breakdowns showing monthly trends and budget variances." },
                { e: "🔔 Limit Alerts", d: "Receive push notices as specific categories approach customized caps." },
              ].map(({ e, d }, i) => (
                <div key={i} className="p-4 bg-card border border-border rounded-[var(--radius-md)] space-y-1">
                  <h4 className="text-xs font-bold text-foreground">{e}</h4>
                  <p className="text-[10px] text-muted-foreground leading-normal">{d}</p>
            ...
            <div>
              <Link to="/features/expenses" className="uc-btn-primary bg-gradient-to-r from-rose-500 to-amber-500 inline-flex items-center gap-1.5">
                Explore Expenses System <ArrowRight className="w-3.5 h-3.5" />
              </Link>
            </div>
          </div>
          <TabletFrame><ExpensesPreview /></TabletFrame>
        </section>

        <div className="h-px bg-border/40" />

        {/* ── 5. ALUMNI ─────────────────────────────────────────────── */}
        <section className={sectionGrid} style={{ alignItems: "start" }}>
          <div className={`${textCol} lg:sticky lg:top-24`}>
            ...
            <h2 className={featureHeading}>Alumni Network Mentorship</h2>
            <p className={featureDesc}>
            ...
            <div>
              <Link to="/features/alumni" className="uc-btn-primary bg-gradient-to-r from-amber-500 to-rose-500 inline-flex items-center gap-1.5">
                Access Alumni Network <ArrowRight className="w-3.5 h-3.5" />
              </Link>
            </div>
          </div>

          {/* Timeline */}
          <div className="flex flex-col gap-7 text-left relative pl-6 border-l border-border/80">
            {[
        ...
        <section className={sectionGrid}>
          ...
          <div className={textCol}>
            ...
            <h2 className={featureHeading}>Central Student Dashboard</h2>
            <p className={featureDesc}>
            ...
            <div>
              <Link to="/features/dashboard" className="uc-btn-primary bg-gradient-to-r from-purple-500 to-indigo-500 inline-flex items-center gap-1.5">
                Deep-Dive into Dashboard <ArrowRight className="w-3.5 h-3.5" />
              </Link>
            </div>
          </div>
        </section>
