 ...
 * Includes specific role-based colors (student, verifier, alumni) and custom effects.
 */
...
/**
 * Button Component
 * Supports 'asChild' for Radix UI slot behavior, allowing it to render as a different element (like a Link).
 */
